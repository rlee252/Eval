...
public class ExprEvaluatorTest2
{
   ...
   public static void main(String[] args)
   {
    ...
    ExprEvaluator2 expr1 = new ExprEvaluator2(); //construct an expression via keyboard
    ExprEvaluator2 expr2 = new ExprEvaluator2("3+4."); //enter an expression via string parameter
